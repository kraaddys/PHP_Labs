...
![image](https://i.imgur.com/y7JH0uU.png) - Окно приложения XAMPP, где все уже настроено

![image](https://i.imgur.com/VKtgTVj.png) - Созданные таблицы в БД phpMyAdmin
...
![image](https://i.imgur.com/LRbqouS.png) - Главная страница с рецептами

![image](https://i.imgur.com/xpyr1qq.png) - Открытая информация о рецепте

![image](https://i.imgur.com/6ll1eXg.png) - Страница редактирования рецепта

![image](https://i.imgur.com/vJnZ0BC.png) - Что происходит после нажатия кнопки "Удалить"

![image](https://i.imgur.com/oJw5cgW.png) - Страница добавления рецепта
